  ...
  return (
    <>
      ...
      <Routes >
        ...
        <Route path="/contact" element={<Contact_Section map={map} />} />
      </Routes>
      <Footer />
    </>
  );
